    ...
    async getTestCaseById(testCaseId: string) {
        ...
        try {
            ...
            if (
                ...
                throw new Error(
                    'Test Case ID must be a valid UUID'
                );
            }
            ...
            const normalizedIdLowerCase =
                normalizedTestCaseId.toLowerCase();
            ...
            return {
                editing:
                    responseData?.editing ??
                    false,

                data: matchedTestCase
                    ? [matchedTestCase]
                    : [],
            };
        } catch (error: any) {
    ...
    async getTestPlanById(testPlanId: string) {
        ...
        try {
            if (
                ...
                throw new Error(
                    'Test Plan ID is required and must be a valid UUID'
                );
            }
            ...
            if (
                ...
                throw new Error(
                    'Test Plan ID must be a valid UUID'
                );
            }
            ...
            const normalizedIdLowerCase =
                normalizedTestPlanId.toLowerCase();
    ...
    async listTestPlansByProjectId(projectId: string) {
        ...
        try {
            if (
                ...
                throw new Error(
                    'Project ID is required and must be a valid UUID'
                );
            }
            ...
            const normalizedProjectIdLowerCase =
                normalizedProjectId.toLowerCase();

            const matchingTestPlans =
                testPlans.filter(
                    (testPlan: any) => {
    ...
    async listTestCasesByTestPlan(testPlanName: string) {
        ...
        try {
            if (
                ...
                throw new Error(
                    'Test Plan Name is required and must be a string'
                );
            }
            ...
            const normalizedNameLowerCase =
                normalizedTestPlanName.toLowerCase();
